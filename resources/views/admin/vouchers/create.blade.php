        ...
        <div class="card-body">
            <form action="{{ route('admin.vouchers.store') }}" method="POST">
                    ...
                    <div class="col-md-8 mb-3">
                        ...
                        <select name="discount_type" id="discount_type" class="form-select">
                            ...
                            <option value="percent" {{ old('discount_type') === 'percent' ? 'selected' : '' }}>Phần trăm
                                (%)</option>
                            <option value="amount" {{ old('discount_type') === 'amount' ? 'selected' : '' }}>Số tiền
                                (VNĐ)</option>
                        </select>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 mb-3">
                        ...
                        <select name="status" class="form-select">
                            ...
                            <option value="inactive" {{ old('status') === 'inactive' ? 'selected' : '' }}>Tạm ngưng
                            </option>
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <a href="{{ route('admin.vouchers.index') }}" class="btn btn-secondary"><i
