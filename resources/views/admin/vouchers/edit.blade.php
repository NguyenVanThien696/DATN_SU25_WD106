        ...
        <div class="card-body">
            <form action="{{ route('admin.vouchers.update', $voucher->id) }}" method="POST">
                    ...
                    <div class="col-md-8 mb-3">
                        ...
                        <select name="discount_type" id="discount_type" class="form-select rounded-pill">
                            ...
                            <option value="percent"
                                ...
                                trăm (%)</option>
                            <option value="amount"
                                {{ old('discount_type', $voucher->discount_type) === 'amount' ? 'selected' : '' }}>Số
                                tiền (VNĐ)</option>
                        </select>
                ...
                <div class="row d-none" id="discount_percent_group">
                    ...
                    <div class="col-md-8 mb-3" id="max_discount_group">
                        <label class="form-label fw-semibold">Số tiền giảm tối đa (VNĐ)</label>
                        <div class="input-group">
                            <input type="number" name="max_discount_amount" class="form-control rounded-pill"
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 mb-3">
                        ...
                        <input type="number" step="1000" class="form-control" name="min_order_amount"
                            id="min_order_amount"
                    ...
                    <div class="col-md-8 mb-3">
                        ...
                        <select name="status" class="form-select rounded-pill">
                            ...
                            <option value="inactive"
                                {{ old('status', $voucher->status) === 'inactive' ? 'selected' : '' }}>Tạm ngưng
                            </option>
