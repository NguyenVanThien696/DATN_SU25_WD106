...
<div class="container mt-4">
    ...
    <form action="{{ route('admin.vouchers.update', $voucher->id) }}" method="POST">
        ...
        <div class="mb-3" id="discount_percent_group">
            ...
            <input type="number" name="discount_percent" class="form-control" value="{{ old('discount_percent', $voucher->discount_percent) }}">
        ...
        <div class="mb-3" id="discount_amount_group">
            ...
            <input type="number" name="discount_amount" class="form-control" value="{{ old('discount_amount', $voucher->discount_amount) }}">
...
{{-- JavaScript ẩn/hiện input dựa theo discount_type --}}
@push('scripts')
<script>
