...
@section('content')
    ...
    {{-- FORM ĐẶT HÀNG: action -> client.checkout.place --}}
    <form action="{{ route('client.checkout.process', Auth::id()) }}" method="POST">
        @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="p-3 p-lg-5 border bg-white">
                            ...
                            <div class="form-group mt-3">
                                ...
                                @error('c_order_notes') <small class="text-danger">{{ $message }}</small> @enderror
                            </div>

                            {{-- Hidden để luôn submit 0/1 --}}
                            ...
                            <div class="form-group mt-3">
                                <label for="c_ship_different_address" class="text-black" data-bs-toggle="collapse"
                                       ...
                                       aria-expanded="{{ old('ship_to_different', 0) == 1 ? 'true' : 'false' }}"
                                       aria-controls="ship_different_address">
                                    <input type="checkbox" value="1" name="ship_to_different" id="c_ship_different_address"
                                           {{ old('ship_to_different', 0) == 1 ? 'checked' : '' }}>
                                    Giao đến một địa chỉ khác?
                                </label>

                                <div class="collapse {{ old('ship_to_different', 0) == 1 ? 'show' : '' }}" id="ship_different_address">
                                    <div class="py-2">
                                        ...
                                        <div class="form-group row mt-3">
                                            <div class="col-md-12">
                                                <label class="text-black">Địa chỉ nhận hàng <span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group row mt-3">
                                            <div class="col-md-12">
                                                <label class="text-black">Địa chỉ Email <span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group mt-3">
                                            ...
                                            @error('shipping_note') <small class="text-danger">{{ $message }}</small> @enderror
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="p-3 p-lg-5 border bg-white">
                            ...
                            {{-- Gửi tổng tiền về server để validate/placeOrder --}}
                            <input type="hidden" name="total_price" value="{{ $finalTotal + $shippingFee }}">

                            {{-- Nhập mã giảm giá: dùng formaction để không submit vào placeOrder --}}
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append ms-2">
                                        <button type="submit" name="apply_coupon" value="1"
                                                ...
                                                formaction="{{ route('client.checkout.coupon.apply') }}">
                                            Áp dụng
                                        </button>
                                    </div>
                                </div>
