        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsFurni">
                <ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
                    ...
                    <li><a class="nav-link" href="{{ route('client.products.index') }}">Cửa hàng</a></li>
                    <li><a class="nav-link" href="{{ route('client.about.index') }}">Về chúng tôi</a></li>
                    <li><a class="nav-link" href="#">Dịch vụ</a></li>
                    <li><a class="nav-link" href="{{ route('client.blog.index') }}">Blog</a></li>
                    <li><a class="nav-link" href="{{ route('client.contact.index') }}">Liên hệ với chúng tôi</a></li>
                </ul>
                            ...
                            <div class="form-group row mt-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="address" name="address"
                                        placeholder="Street address" value="{{ old('name', $user->address) }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row mt-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="phone" name="phone"
                                        placeholder="Phone Number" value="{{ old('name', $user->phone ) }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group mt-3">
                                <label for="c_ship_different_address" class="text-black" data-bs-toggle="collapse"
                                    ...
                                    aria-controls="ship_different_address"><input type="checkbox" value="1"
                                        id="c_ship_different_address">Giao đến một địa chỉ khác?</label>
                    ...
                    <form method="POST" action="{{ route('coupon.apply') }}">
                        ...
                        <div class="row mb-5">
                            <div class="col-md-12">
                                ...
                                <div class="p-3 p-lg-5 border bg-white">
                                    <label for="c_code" class="text-black mb-3">Nhập mã phiếu giảm giá của bạn nếu bạn
                                        có</label>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-black font-weight-bold"><strong
                                                    id="final-total">{{ number_format($total) }}</strong></td>
                                        </tr>
                                ...
                                <div class="border p-3 mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="payment_method" id="cod"
                                            value="cod" data-bs-toggle="collapse" data-bs-target="#collapsecod" checked>
                                        <label class="form-check-label" for="cod">
                                            Thanh toán khi nhận hàng (COD)
                                        </label>
                                    </div>
                                    <div id="collapsecod" class="collapse show mt-2">
                                        <small class="text-muted">
                                            Bạn sẽ thanh toán khi nhận được hàng từ nhân viên giao hàng.
                                        </small>
                                    </div>
                                </div>
                                ...
                                <div class="border p-3 mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="payment_method" id="paypal"
                                            value="paypal" data-bs-toggle="collapse" data-bs-target="#collapsepaypal">
                                        <label class="form-check-label" for="paypal">
                                            Thanh toán qua Paypal
                                        </label>
                                    </div>
                                    <div id="collapsepaypal" class="collapse mt-2">
                                        <small class="text-muted">
                                            Bạn sẽ được chuyển đến trang Paypal để hoàn tất thanh toán.
                                        </small>
                                    </div>
                                </div>
            ...
            .then(data => {
                if (data.error) {
                    ...
                    document.getElementById('discount-amount').innerText = data.discount_amount
                        .toLocaleString() + ' VNĐ';
                    document.getElementById('final-total').innerText = data.final_total.toLocaleString() +
                        ' VNĐ';

                    // Nếu bạn cần gửi lại coupon khi submit đơn hàng:
