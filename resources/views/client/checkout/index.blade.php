  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
	...
	<body>
		...
		<nav class="custom-navbar navbar navbar navbar-expand-md navbar-dark bg-dark" arial-label="Furni navigation bar">
			...
			<div class="container">
				<a class="navbar-brand" href="{{ route('client.index') }}">Furni<span>.</span></a>
				...
				<div class="collapse navbar-collapse" id="navbarsFurni">
					<ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
						...
						<li><a class="nav-link" href="{{ route('client.products.index') }}">Shop</a></li>
						<li><a class="nav-link" href="{{ route('client.about.index') }}">About us</a></li>
						<li><a class="nav-link" href="#">Services</a></li>
						<li><a class="nav-link" href="{{ route('client.blog.index') }}">Blog</a></li>
						<li><a class="nav-link" href="{{ route('client.contact.index') }}">Contact us</a></li>
					</ul>
